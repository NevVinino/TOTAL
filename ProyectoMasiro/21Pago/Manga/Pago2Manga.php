        ...
        <form action="php/mostrarcontacto3.php" method="POST" class="registra">
            <fieldset class="registrafieldset">
                ...
                <p>
                    ...
                    Costo del manga#2: 20$</p>
                <center>
                    <img src="../../imagenes/img/perfil.jpg" alt="" width="150" > <br>
                </center>   
                <br>
                <label for="">Cuantos posters desea comprar:</label>
                <input type="number" name="cant" id="numem2"  required> <br><br>
                <button type="button"  onclick="costom2(
                    document.getElementById('numem2').value)">Calcular</button>
                    <br>
                <p>Costo total: <span id="resultadom2"> </span> $</p> <br>
