    ...
    <body background="../../imagenes/img/negrofondo.jpg" text="FFFFF">
        ...
        <form action="php/mostrarcontacto4.php" method="POST" class="registra">
            <fieldset class="registrafieldset">
                ...
                <input type="number" name="cant" id="numem3"  required> <br><br>
                <button type="button"  onclick="costom3(
                    document.getElementById('numem3').value)">Calcular</button>
                    <br>
                <p>Costo total: <span id="resultadom3"> </span> $</p> <br>
