...
$cantmeses=htmlentities($_POST["cantmeses"]);
...
//database
echo $query="INSERT INTO pagossub(Fecha,Hora,Correo,CantidadMeses,PagoTotal,Tarjeta,Titular,InfTarjeta1,
InfTarjeta2,InfTarjeta3,Pais,GuardarDatos) VALUES ('$fecha','$hora','$correo','$cantmeses','$pagototal','$ec','$titular',
...
<table class="table table-striped table-hover">
    <tr>
        <th colspan="2">Pago Suscripcion (cantidad de meses que quiera el usuario)</th>
    </tr>
    <tr>
    ...
    <tr>
        <td>Cantidad de Meses que quiere suscribirse:</td>
        <td><?= ucwords($cantmeses)?></td>
    </tr>
    <tr>
        <td>Pago total:</td>
