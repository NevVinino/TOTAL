<html>
    <head>
        ...
        <title>Masiro &reg; Pago2Sub</title>
    ...
    <body background="../../imagenes/img/negrofondo.jpg" text="FFFFF">
        ...
        <form action="php/mostrarcontacto3.php" method="POST"  class="registra">
            <fieldset class="registrafieldset">
                ...
                <label for="">Rellene el valor con 4 sino la compra no procederá<br> Recuerde que la moneda es en $ (dolares) <br> Se suscribirá por 2 meses si realiza la compra:</label>
                <input type="number" name="pagosub" id="" min="4" max="4"> <br><br>
