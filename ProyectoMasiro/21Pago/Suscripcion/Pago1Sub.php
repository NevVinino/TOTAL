    ...
    <body background="../../imagenes/img/negrofondo.jpg" text="FFFFF">
        ...
        <form action="php/mostrarcontacto2.php" method="POST"  class="registra">
            <fieldset class="registrafieldset">
                ...
                <label for="">Rellene el valor con 2 sino la compra no procederá<br> Recuerde que la moneda es en $ (dolares) <br> Se suscribirá por 1 mes si realiza la compra:</label>
                <input type="number" name="pagosub" id="" min="2" max="2"> <br><br>
