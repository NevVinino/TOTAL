<html>
    ...
    <body background="../../imagenes/img/negrofondo.jpg" text="FFFFF">
        ...
        <form action="php/mostrarcontactoS1.php" method="POST" class="registra">
            <fieldset class="registrafieldset">
                ...
                <input type="number" name="cantmeses" id="numeS" min="1" max="12" required> <br><br>
                <button type="button"  onclick="costoS(
                    document.getElementById('numeS').value)">Calcular</button>
                    <br>
                <p>Costo total: <span id="resultadoS"> </span> $</p> <br>
