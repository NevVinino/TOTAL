<html>
    <head>
        ...
        <title>Masiro &reg; Pago3Posters</title>
         <!-- Agregar css: externa -->
        ...
        <form action="php/mostrarcontacto4.php" method="POST"  class="registra">
            <fieldset class="registrafieldset">
                ...
                <p>
                    ...
                    Costo del poster#3: 30$</p>
                <center>
                    <img src="../../imagenes/img/perfil.jpg" alt="" width="150" > <br>
                </center>   
                <br>
                <label for="">Cuantos posters desea comprar:</label>
                <input type="number" name="cant" id="numep3"  required> <br><br>
                <button type="button"  onclick="costop3(
                    document.getElementById('numep3').value)">Calcular</button>
                    <br>
                <p>Costo total: <span id="resultadop3"> </span> $</p> <br>
