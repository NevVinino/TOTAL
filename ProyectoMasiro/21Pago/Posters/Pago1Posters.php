        ...
        <form action="php/mostrarcontacto2.php" method="POST" class="registra">
            <fieldset class="registrafieldset">
                ...
                <p>
                    ...
                    Costo del poster#1: 10$</p>
                <center>
                    <img src="../../imagenes/img/perfil.jpg" alt="" width="150" > <br>
                </center>   
                <br>
                <label for="">Cuantos posters desea comprar:</label>
                <input type="number" name="cant" id="numep1"  required> <br><br>
                <button type="button"  onclick="costop1(
                    document.getElementById('numep1').value)">Calcular</button>
                    <br>
                <p>Costo total: <span id="resultadop1"> </span> $</p> <br>
