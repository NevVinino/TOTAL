<html>
    <head>
        ...
        <title>Masiro &reg; Pago1Posters</title>
    ...
    <body background="../../imagenes/img/negrofondo.jpg" text="FFFFF">
        ...
        <header>
             <h1>PagoPosters #2 Costo 20$</h1>
        </header>
        <div class="clearfix"></div>
        <form action="php/mostrarcontacto3.php" method="POST" class="registra">
            <fieldset class="registrafieldset">
                ...
                <input type="number" name="cant" id="numep2"  required> <br><br>
                <button type="button"  onclick="costop2(
                    document.getElementById('numep2').value)">Calcular</button>
                    <br>
                <p>Costo total: <span id="resultadop2"> </span> $</p> <br>
