    ...
    <body  background="../imagenes/img/negrofondo.jpg" text="white">
        ...
        <form action="php/mostrarcontacto2.php" method="POST" class="registra">
            ...
            <fieldset class="registrafieldset">
                ...
                <input type="text" name="nombre" id="re" placeholder="Ingrese su nombre" required>
                <br> <br>
                <input type="text" name="user" id="re" placeholder="Ingrese su nombre de usuario" required>
                <br> <br>
                <input type="email" name="correo" id="re" placeholder="Ingrese su correo" required>
                <br> <br>
                <input type="password" name="pass" id="re" placeholder="Contraseña" required>
                <br> <br>
                <input type="password" name="pass2" id="re" placeholder="Repita su contraseña"> <br> <br>
                <label for="">¿Eres un bot?</label> <br>
                <input type="radio" name="ec" id="re" value="SI">Si <br> <br>
                <input type="radio" name="ec" id="re" value="NO">No <br>
                <img src="../imagenes/img/mieruko.png" width="120" alt="">
                <br>

                <input type="radio" name="acept" id="">He leído y acepto las normas <br> <br>
