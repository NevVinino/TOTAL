<html>
    <head>
        ...
        <title>Masiro &reg; Contactanos</title>
    ...
    <body  background="../imagenes/img/negrofondo.jpg" text="white">
        ...
        <form action="php/mostrarcontacto.php" method="POST" class="registra">

            <fieldset class="registrafieldset"> 
                <legend>Contactamos </legend>
                ...
                <br> <br>
                <label for="">Situación</label> <br>
                <input type="radio" name="ec" id="" value="Ayuda">Ayuda<br>
                <input type="radio" name="ec" id="" value="Contactar con la empresa">Contactar con la empresa<br><br>
                <label for="">Expliquemos la motivo:</label> <br>
                <textarea id="texto" cols="60" name="textarea" rows="10"></textarea> <br><br>
                <label for="">Adjunte de archivo</label> <br>
                <input type="file" name="archivo" id=""> <br>
                <label for="">¿Eres un bot?</label> <br><br>
                <input type="radio" name="eboot" id="" value="SI">Si <br> 
                <input type="radio" name="eboot" id="" value="NO">No <br>
                <img src="../imagenes/img/mieruko.png" width="120" alt="">
                <br>
                <input type="radio" name="acept" id="" name="si">He leído y acepto las normas <br> <br>
                <input type="submit" value="Enviar">
            </fieldset>
        </form>
        <div class="fila">
            <center>
                Comuniquese con nosotros a traves de nuestras redes o en tal caso a este EMAIL que se centra principalmente este rubro <br>
    
                        EMAIL: aaaaaaaaaaaaaa@hotmail.com
            </center>
