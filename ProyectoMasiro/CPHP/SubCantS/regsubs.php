<?php
    $correo=$_POST['correo'];
    $numS=$_POST['numeS'];
    $costototal=$_POST['resultadoS'];
    $tarjeta=$_POST['ec'];
    $titular=$_POST['titular'];
    $inftarjeta1=$_POST['it1'];
    $inftarjeta2=$_POST['it2'];
    $inftarjeta3=$_POST['it3'];
    $pais=$_POST['pais'];
    $guardar=$_POST['conf'];
...
<html>
    <head>
        ...
        <title>Masiro &reg; Pago1Sub</title>
        <!-- Agregar css: externa -->
    ...
    <body background="../../imagenes/img/negrofondo.jpg" text="FFFFF">
        ...
        <header>
            <h1>Suscribete la cantidad de meses que quieras</h1>
        </header>
        <form action=""  class="registra">
            <fieldset class="registrafieldset">
                ...
                <p>
                    ...
                    Costo por cada mes de Suscripción: 2$</p>
                
                <br>
                <label for="">Por cuantos meses desea suscribirse:</label>
                <input type="number" name="numeS" id="numeS" min="1" max="12" required> <br><br>
                <button type="button"  onclick="costoS(
                    document.getElementById('numeS').value)">Calcular</button>
                    <br>
                <p>Costo total: <span id="resultadoS" name="resultadoS"> </span> $</p> <br>


                <label for="">Tarjeta:</label> <br>
                <input type="radio" name="ec" id="" value="Isapre" value="VISA">VISA<br>
                ...
                <input type="text" name="it1" id="" placeholder="1234 1234 1234 1234"> <br><br>
                <input type="text" name="it2" id="" placeholder="MM / AA"> <br><br>
                <input type="text" name="it3" id="" placeholder="CVC"> <br><br>
                ...
                <br><br>
                <input type="checkbox" name="conf" id=""> Guardar mis cosas para un proceso de compra seguro en un clic <br> <br><br>
                <img src="../../imagenes/img/HachikujiMoney.gif" alt=""><br>
